...
public enum TL {
    ...
    COMMAND_SHOW_DTR("<a>DTR: <i>%1$s / %2$s <a>Raidable: <i>%3$s"),
    COMMAND_SHOW_HOME_SET("<a>Faction Home: <i>%1$s, %2$s, %3$s, %4$s"),
    COMMAND_SHOW_HOME_UNSET("<a>Faction Home: <i>Not set"),
    COMMAND_SHOW_FROZEN("<a>DTR Freeze: <i>%s"),
