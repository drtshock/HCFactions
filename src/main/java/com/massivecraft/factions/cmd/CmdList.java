...
public class CmdList extends FCommand {
    ...
    public void perform() {
        ...
        for (Faction faction : factionList.subList(start, end)) {
            ...
            lines.add(p.txt.parse("%s<i> %d/%d online, %d/%d", faction.getTag(fme), faction.getFPlayersWhereOnline(true).size(), faction.getFPlayers().size(), faction.getLand(), faction.getMaxLand()));
        }
